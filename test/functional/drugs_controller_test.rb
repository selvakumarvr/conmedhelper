...
class DrugsControllerTest < ActionController::TestCase
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post :create, drug: { category: @drug.category, information: @drug.information, name: @drug.name }
    end
  ...
  test "should update drug" do
    put :update, id: @drug, drug: { category: @drug.category, information: @drug.information, name: @drug.name }
    assert_redirected_to drug_path(assigns(:drug))
  end
