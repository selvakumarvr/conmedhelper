namespace :db do
  ...
  task :populate => :environment do
    ...
    #Step 2: Add drugs
       ...
       antipsychotics = Drug.new
       antipsychotics.medication_name = "antipsychotics"
       antipsychotics.category = "prohibited"
       antipsychotics.information = "Prior to randomization 7 day wash out except clozaril (30 days) and depot longacting injectable (1.5 unit dosing interval ) during double blind treatment period all antipsychotics prohibited."
       antipsychotics.study_id = study1.id
       antipsychotics.save!


       atypical_antipsychotics = Drug.new
       atypical_antipsychotics.medication_name = "atypical antipsychotics"
       atypical_antipsychotics.category = "prohibited"
       atypical_antipsychotics.information = "Prior to randomization 7 day wash out except clozaril (30 days) and depot longacting injectable (1.5 unit dosing interval ) during double blind treatment period all antipsychotics prohibited."
       atypical_antipsychotics.study_id = study1.id
       atypical_antipsychotics.save!
       ...
       antidepressants11 = Drug.new
       antidepressants11.medication_name = "antidepressants"
       antidepressants11.category = "restricted"
       antidepressants11.information = "allowed prior to randomization allowed provided tha dose has been stable for 30 days prior to randomization except {eymbaua pxil prozac}, paxeva during double blind treatment phase subject will remain on same dose throughout the study."
       antidepressants11.study_id = study1.id
       antidepressants11.save!
       ...
       mood_stabilizers = Drug.new
       mood_stabilizers.medication_name = "mood stabilizers"
       mood_stabilizers.category = "prohibited"
       mood_stabilizers.information = "prior to randomization 7 day washout during double blind treatment period prohibited."
       mood_stabilizers.study_id = study1.id
       mood_stabilizers.save!
       
       anticonvulsants = Drug.new
       anticonvulsants.medication_name = "anticonvulsants"
       anticonvulsants.category = "prohibited"
       anticonvulsants.information = "prior to randomization 7 day washout during double blind treatment period prohibited."
       anticonvulsants.study_id = study1.id
       anticonvulsants.save!
       ...
       painkillers = Drug.new
       painkillers.medication_name = "painkillers"
       painkillers.category = "prohibited"
       painkillers.information = "Prohibited unless permission is obtained from the medical monitor. Permission for opioid use may be considered for a documented and clinically appropriate indication (eg, episodic pain condition, tooth extraction) if prescribed at a medically appropriate dose and frequency."
       painkillers.study_id = study1.id
       painkillers.save!


       analgecies = Drug.new
       analgecies.medication_name = "analgecies"
       analgecies.category = "prohibited"
       analgecies.information = "Prohibited unless permission is obtained from the medical monitor. Permission for opioid use may be considered for a documented and clinically appropriate indication (eg, episodic pain condition, tooth extraction) if prescribed at a medically appropriate dose and frequency."
       analgecies.study_id = study1.id
       analgecies.save!
       
       
       opiods = Drug.new
       opiods.medication_name = "opiods"
       opiods.category = "prohibited"
       opiods.information = "Prohibited unless permission is obtained from the medical monitor. Permission for opioid use may be considered for a documented and clinically appropriate indication (eg, episodic pain condition, tooth extraction) if prescribed at a medically appropriate dose and frequency."
       opiods.study_id = study1.id
       opiods.save!
       ...
       anticholinergics = Drug.new
       anticholinergics.medication_name = "anticholinergics"
       anticholinergics.category = "prohibited"
       anticholinergics.information ="Prior to Randomization 7 day washout, During double blind treatment period prohibited."
       anticholinergics.study_id = study1.id
       anticholinergics.save!
       ...
       antihypertensives = Drug.new
       antihypertensives.medication_name = "antihypertensives"
       antihypertensives.category = "restricted"
       antihypertensives.information ="Prior to randomization, allowed provided that the dose has been stable for 30 days prior to randomization, during, Subject will remain on the same dose throughout the duration of the trial."
       antihypertensives.study_id = study1.id
       antihypertensives.save!

       bloodpressure_medications = Drug.new
       bloodpressure_medications.medication_name = "bloodpressure_medications"
       bloodpressure_medications.category = "restricted"
       bloodpressure_medications.information ="Prior to randomization, allowed provided that the dose has been stable for 30 days prior to randomization, during, Subject will remain on the same dose throughout the duration of the trial."
       bloodpressure_medications.study_id = study1.id
       bloodpressure_medications.save!
       
       
       medical_conditions_other = Drug.new
       medical_conditions_other.medication_name = "Medical conditions (other) and allowed list"
       medical_conditions_other.category = "restricted"
       medical_conditions_other.information ="Prior to randomization, allowed provided that the dose has been stable for 30 days prior to randomization, during, Subject will remain on the same dose throughout the duration of the trial."
       medical_conditions_other.study_id = study1.id
       medical_conditions_other.save!
       ...
       nutritional_supplements = Drug.new
       nutritional_supplements.medication_name = "nutritional supplements" 
       nutritional_supplements.brand_name = ""
       nutritional_supplements.category = "prohibited"
       nutritional_supplements.information = "Prior to randomization 7 day washout, During double blind treatment priod prohibited."
       nutritional_supplements.study_id = study1.id 
       nutritional_supplements.save!
       
       herbal_medications = Drug.new
       herbal_medications.medication_name = "herbal medications" 
       herbal_medications.brand_name = ""
       herbal_medications.category = "prohibited"
       herbal_medications.information = "Prior to randomization 7 day washout, During double blind treatment priod prohibited."
       herbal_medications.study_id = study1.id 
       herbal_medications.save!
       
       st_johns_wort = Drug.new
       st_johns_wort.medication_name = "st johns wort" 
       st_johns_wort.brand_name = ""
       st_johns_wort.category = "prohibited"
       st_johns_wort.information = "Prior to randomization 7 day washout, During double blind treatment priod prohibited."
       st_johns_wort.study_id = study1.id 
       st_johns_wort.save!
